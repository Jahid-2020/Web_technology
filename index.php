        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="https://th.bing.com/th/id/OIP.qpwcMBaHCmtMSSLVsZRVKwHaEK?w=282&h=180&c=7&r=0&o=7&dpr=1.1&pid=1.7&rm=3" class="card-img-top" alt="Clothing">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Photo itor X</h5>
                            <p class="card-text">Price: ৳1200</p>
                            <a href="#" class="btn btn-success">Buy Now</a>
                        </div>
                    </div>
